...
// [sumOfNumbers, 'The sum of ' +a+' and ' +b+' is ' + sumOfNumbers +'.']
  let sumArray = [sumOfNumbers, 'The sum of ' +a+' and ' +b+' is ' + sumOfNumbers +'.']
  return sumArray;
}
...
function multiply(a, b) { //eslint-disable-line
  ...
  let productArray = [productOfNumbers, 'The product of ' +a+' and ' +b+' is ' + productOfNumbers +'.'];
  return productArray;
}
...
let stringArray = testDynamicArray.join();

function multiplyAnyArray(testDynamicArray) { //eslint-disable-line
  var product = 1;
  for (var i=0; i < testDynamicArray.length; i++){
    product = multiply(product,testDynamicArray[i]);
    product = product[0];
  } let dynamicArray = [product, 'The numbers ' + stringArray + ' have a product of ' + product + '.'];
